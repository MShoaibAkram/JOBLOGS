    ...
    <div class="subheader py-2 py-lg-4 subheader-transparent" id="kt_subheader">
        <div class="container d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
            ...
            <div class="d-flex align-items-center">
                <a href="{{url('admin/jobs')}}" class="btn btn-default font-weight-bold">Back</a>
            </div>
        </div>
    </div>
                            ...
                            <div class="d-flex align-items-center justify-content-between flex-wrap">
                                <div class="mr-3">
                                    <div class="d-flex align-items-center mr-3">
                                        <a href="#" class="d-flex align-items-center text-dark text-hover-primary font-size-h5 font-weight-bold mr-3">{{$job->title}}</a>
                                        <span class="label {{$job->Status->status_class}} label-inline font-weight-bolder mr-1">{{$job->Status->status}}</span>
                                            ...
                                            <div class="dropdown-menu dropdown-menu-md dropdown-menu-right">
                                                <ul class="navi navi-hover">
                                                    <li class="navi-header font-weight-bold py-4">
                                                        <span class="font-size-lg">Update Job Status:</span>
                                                        <i class="flaticon2-information icon-md text-muted" data-toggle="tooltip" data-placement="right" title="Click to learn more..."></i>
                                                    </li>
                                                    <li class="navi-separator mb-3 opacity-70"></li>
                                                    @foreach($jobStatus as $status)
                                                        <li class="navi-item">
                                                            <a href="{{url('admin/jobs/update_status')}}/{{$job->id}}/{{$status->id}}" class="navi-link">
                                                                <span class="navi-text">
                                                                    <span class="label label-xl label-inline {{$status->status_class}}">{{$status->status}}</span>
                                                                </span>
                                                            </a>
                                                        </li>
                                                    @endforeach
                                    ...
                                    <div class="d-flex flex-wrap my-2">
                                        <a href="#" class="text-muted text-hover-primary font-weight-bold mr-lg-8 mr-5 mb-lg-0 mb-2">
                                            <span class="svg-icon svg-icon-md svg-icon-gray-500 mr-1">
                                                <img src="{{asset('media/svg/icons/General/Clip.svg')}}" style="width: 20px"/>
                                            </span>
                                            {{$job->created_at}}
                                        </a>
                                    </div>
                    ...
                    <div class="card card-custom">
                        ...
                        <div class="card-body py-4">
                            <div class="form-group row my-2">
                                ...
                                <div class="col-8">
                                    <span class="form-control-plaintext font-weight-bolder">{{$job->Company->name}}</span>
                                </div>
                            </div>
                            <div class="form-group row my-2">
                                <label class="col-4 col-form-label">Email:</label>
                                <div class="col-8">
                                    <span class="form-control-plaintext font-weight-bolder">{{$job->Company->email}}</span>
                                </div>
                            </div>
                            <div class="form-group row my-2">
                                <label class="col-4 col-form-label">Phone:</label>
                                <div class="col-8">
                                    <span class="form-control-plaintext font-weight-bolder">{{$job->Company->phone}}</span>
                                </div>
                            </div>
                            <div class="form-group row my-2">
                                <label class="col-4 col-form-label">Address:</label>
                                <div class="col-8">
                                    <span class="form-control-plaintext font-weight-bolder">{{$job->Company->address}}</span>
                                </div>
                            </div>
                        </div>
                    </div>
