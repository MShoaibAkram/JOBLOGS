        ...
        <div class="container">
            ...
            <div class="d-none d-lg-flex align-items-center mr-3">
                ...
                <a href="index.html" class="mr-20">
                    <h3 class="text-white max-h-35px">JOB LOGS</h3>
                </a>
                <!--end::Logo-->
                ...
                <ul class="header-tabs nav align-self-end font-size-lg" role="tablist">
                    <!--begin::Item-->
                    <li class="nav-item">
                        <a href="#"  class="nav-link py-4 px-6 @if(request()->is('admin')) active @endif" data-toggle="tab" data-target="#kt_header_tab_1" role="tab">Home</a>
                    </li>
                    <!--end::Item-->

                    <li class="nav-item">
                        <a href="#"  class="nav-link py-4 px-6 @if(request()->is('admin/jobs*')) active @endif" data-toggle="tab" data-target="#kt_header_tab_jobs" role="tab">Jobs</a>
                    </li>


                    <!--begin::Item-->
                    <li class="nav-item mr-3">
                        <a href="#" class="nav-link py-4 px-6 @if(request()->is('admin/users*') || request()->is('admin/user*')) active @endif" data-toggle="tab" data-target="#kt_header_tab_user" role="tab">Users</a>
                    </li>
                    <!--end::Item-->
                    <!--begin::Item-->
                    <li class="nav-item mr-3">
                        <a href="#" class="nav-link py-4 px-6 @if(request()->is('admin/clients*') || request()->is('admin/client*')) active @endif" data-toggle="tab" data-target="#kt_header_tab_2" role="tab">Clients</a>
                    </li>
                    <!--end::Item-->
                    <!--begin::Item-->
                    <li class="nav-item mr-3">
        ...
        <div class="container">
            ...
            <div class="header-navs header-navs-left" id="kt_header_navs">
                ...
                <div class="tab-content">
                    ...
                    <div class="tab-pane p-5 p-lg-0 justify-content-between @if(request()->is('admin/users*') || request()->is('admin/user*')) active @endif" id="kt_header_tab_user">
                        <div class="d-flex flex-column flex-lg-row align-items-start align-items-lg-center">
                            <!--begin::Actions-->
                            <a href="{{url('admin/users')}}" class="btn btn-light font-weight-bold mr-3 my-2 my-lg-0">Index</a>
                            <a href="{{url('admin/users/trashed')}}" class="btn btn-danger font-weight-bold my-2 my-lg-0">Trashed</a>
                            <!--end::Actions-->
                        </div>
                    ...
                    <div class="tab-pane p-5 p-lg-0 justify-content-between @if(request()->is('admin/jobs*') || request()->is('admin/jobs*')) active @endif" id="kt_header_tab_jobs">
                        <div class="d-flex flex-column flex-lg-row align-items-start align-items-lg-center">
                            <!--begin::Actions-->
                            <a href="{{url('admin/jobs')}}" class="btn btn-light font-weight-bold mr-3 my-2 my-lg-0">Index</a>
                            <a href="{{url('admin/jobs/trashed')}}" class="btn btn-danger font-weight-bold my-2 my-lg-0">Trashed</a>
                            <!--end::Actions-->
                        </div>
                    </div>

                    <!--begin::Tab Pane-->
                    <div class="tab-pane p-5 p-lg-0 justify-content-between @if(request()->is('admin/clients*') || request()->is('admin/client*')) active @endif" id="kt_header_tab_2">
                        <div class="d-flex flex-column flex-lg-row align-items-start align-items-lg-center">
                            <!--begin::Actions-->
                            <a href="{{url('admin/clients')}}" class="btn btn-light font-weight-bold mr-3 my-2 my-lg-0">Index</a>
                            <a href="{{url('admin/clients/trashed')}}" class="btn btn-danger font-weight-bold my-2 my-lg-0">Trashed</a>
                            <!--end::Actions-->
                        </div>
                        <div class="d-flex align-items-center">
                            <!--begin::Actions-->
